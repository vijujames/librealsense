...
//        imgFile = "/home/osboxes/projects/librealsense/wrappers/openvino/dominant_plane/images/sl-00001.bmp";
//        dFile = "/home/osboxes/projects/librealsense/wrappers/openvino/dominant_plane/images/sl-00001-D.txt";
        imgFile = "/home/osboxes/rosbags/images/floor1_Color.bmp";
        dFile = "/home/osboxes/rosbags/images/floor1_Depth.raw";
    }
    else {
        imgFile = argv[1];
        dFile = argv[2];
...
//Viju    Mat imgDepth(img.rows, img.cols, CV_8UC1);
    Mat imgDepth(img.rows, img.cols, CV_8UC3);//CV_16UC1
